...
You are provided with a list (or array) of integer arrays (or tuples). Each integer array has 
two items which represent number of people get into bus (The first item) and number of people 
...
#     result = 0
#     for single_stop in bus_stops:
#         result += (single_stop[0] - single_stop[1])
